...
function NavItem({
  ...
  return (
    <Link
      href={href}
      className={`relative px-3 py-2 text-xl ${
        current
    ...
    <>
      <nav className="">
        <div className="container mx-auto px-6 py-2 flex justify-center items-center">
          <NavItem href="/">
            <i className="bx bx-home-alt"></i>寵物石頭
          </NavItem>
          <NavItem href="/my-rock/">
            <i className="bx bx-user"></i> 我ㄉ石頭
          </NavItem>
          <NavItem href="/school/">
            <i className="bx bxs-school"></i> 石頭學校
          </NavItem>
          <NavItem href="/columbarium/">
            <i className="bx bx-ghost"></i> 石頭靈骨塔
          </NavItem>
          <div className="flex-1" />
          <a
            className="flex items-center gap-2 px-3 py-2 rounded-xl text-xl cursor-pointer
